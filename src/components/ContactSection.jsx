...
export const ContactSection = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      toast.success(
        "Email sent successfully. Thankyou to you're message. I'll get back to you soon."
      );
      setIsSubmit(false);
    }, 1500);
    ...
    <section id="contact" className="py-24 px-4 relative bg-secondary/30">
      <div className="container  mx-auto max-w-5xl">
        ...
        <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
          ...
          I'm always open to discussing new opportunties.
        </p>
            ...
            <div className="space-y-6 justify-center">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a
                    href="mailto:EmailMe"
                    className="text-muted-foreground hover:text-primary tranition-colors"
                  >
                    IamNotRealEmail@hello.io
                  </a>
                </div>
              </div>
